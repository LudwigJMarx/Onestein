...
| Contact establishment | `35-contact.md` | How two identities first learn each other's root keys | Commitment over the visual channel as in BQP, rendezvous addresses as in BRP, both credited. The 1952-byte ML-DSA key is why the QR carries a promise rather than the keys |
